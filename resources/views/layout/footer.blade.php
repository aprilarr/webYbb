    ...
    <div class="container">
        <div class="row">
        <div class="col-md-12">
            <h2 class="probootstrap-animate" data-animate-effect="fadeInRight">Terima Kasih Telah Berkunjung</h2>
    ...
    <div class="container">
        ...
        <div class="col-md-4">
            ...
            <h3>Tentang SMP YBB</h3>
            <p>Kami senantiasa mendidik putra dan putri ibu dan bapa sekalian dengan penuh kasih sayang dan rasa sabar demi mewujudkan lulusan yang dapat berguna bagi keluarga, bangsa dan negara.</p>
            <h3>Sosial Media</h3>
        ...
        <div class="col-md-3 col-md-push-1">
            ...
            <ul>
                ...
                <li><a href="http://spmi.yayasanbudibaktibdg.sch.id">SPMI</a></li>
            </ul>
            </div>
        </div>
        <div class="col-md-4">
    ...
    <div class="probootstrap-copyright">
        ...
        <div class="row">
            ...
            <p>Sistem Informasi Penjaminan Mutu Internal SMP YBB =><a href="http://spmi.yayasanbudibaktibdg.sch.id"> SPMI YBB </a></p>
            </div>
